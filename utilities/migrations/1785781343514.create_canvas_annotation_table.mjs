...
class Migration_1785781343514 extends BaseMigration {
  ...
  constructor(dbPool) {
      super(dbPool);
      this.sql = [
        "CREATE TABLE IF NOT EXISTS canvas_annotation (id BIGINT GENERATED ALWAYS AS IDENTITY PRIMARY KEY, canvas_id BIGINT NOT NULL REFERENCES canvas(id) ON DELETE CASCADE, content TEXT NOT NULL, x DOUBLE PRECISION DEFAULT NULL, y DOUBLE PRECISION DEFAULT NULL, width DOUBLE PRECISION DEFAULT NULL, height DOUBLE PRECISION DEFAULT NULL, time_created TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP, time_updated TIMESTAMPTZ NOT NULL DEFAULT CURRENT_TIMESTAMP, time_deleted TIMESTAMPTZ DEFAULT NULL);",
