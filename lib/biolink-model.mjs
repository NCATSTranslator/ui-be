...
export function biolink_class_compare(class_a, class_b) {
  // Handle special cases
  if (class_a === 'biolink:Gene' && class_b === 'biolink:Protein') return -1;
  if (class_a === 'biolink:Protein' && class_b === 'biolink:Gene') return 1;
  let d1 = cmn.jsonGet(BIOLINK_CLASSES, class_a, false);
  let d2 = cmn.jsonGet(BIOLINK_CLASSES, class_b, false);
  if (!d1) {
