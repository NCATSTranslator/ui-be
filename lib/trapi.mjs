...
export function queryToCreativeQuery(query) {
  ...
  function genPathfinderQgraph(subject, object) {
    ...
    nodes[interKey] = makeQNode(false, 'NamedThing');
    const edges = {};
  ...
  switch (queryType) {
    ...
    case 'chemical':
      ...
      break;
    case 'pathfinder':
      qg = genPathfinderQgraph(cmn.jsonGet(query, 'subject'), cmn.jsonGet(query, 'object'));
      break;
    default:
