  ...
  function resultToSmryFgmt(result, kgraph, auxGraphs, startKey, endKey, errors) {
    function analysisToSmryFgmt(analysis, kgraph, auxGraphs, start, ends) {
      ...
      try {
        ...
        const agraph = ag.analysis_to_agraph(analysis, kgraph, auxGraphs); // R!
        const agraph_paths = ag.gen_paths(agraph, kgraph, start, ends, max_path_len);
        ...
        const [summary_paths, edges] = ag.finalize_paths(agraph_paths, agraph.edge_topology, kgraph); // C!
