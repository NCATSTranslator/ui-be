...
function summarize_kedge(eid, kedge, kedge_summarization_rules, summary_context) {
      ...
      try {
        ...
        for (const [eid, edge] of Object.entries(summary_edges)) {
          for (const eb of edge.metadata.edge_bindings) {
            ...
            kedge_properties.push(summarize_kedge(eid, kedge, kedge_summarization_rules, analysis_context));
          }
        }
