...
function answersToSummaryFragments(answers, nodeRules, edgeRules, maxHops) {
  function resultToSummaryFragment(result, kgraph, auxGraphs, startKey, endKey, errors) {
    ...
    try {
      ...
      const rnodeStart = getNodeBindingEndpoints(nodeBindings, startKey)[0];
      const rnodeEnds = getNodeBindingEndpoints(nodeBindings, endKey); // There can be multiple endpoints
