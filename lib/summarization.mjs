...
function genQualifiedPredicate(kedge, invert = false) {
  ...
  predicate = getMostSpecificPredicate(kedge);
...
function mergeTags(summaryTarget, summarySource) {
  Object.keys(summarySource.tags).forEach((k) => {
    summaryTarget.tags[k] = summarySource.tags[k];
  });
  ...
  try {
    ...
    Object.keys(paths).forEach((pid) => {
      ...
      summaryPath.forNids((nid) => {
        ...
        mergeTags(summaryPath, node); // Paths should take all node tags
