...
function genCtdUrl(edge, nodes) {
  ...
  function _genCtdType(curie, node) {
    if (curieLib.isNcbi(curie)) return 'gene';
  ...
  return `https://ctdbase.org/detail.go?type=${type}&acc=${curieLib.genUrlSafeCurie(curie)}${filter}`;
}
