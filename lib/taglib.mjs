...
function make_taggable(obj) {
  if (!cmn.is_object(obj)) {
    throw new cmn.DeveloperError('lib/taglib.mjs', 'make_taggable', `Expected object, got: ${obj}`);
  }
  if (_is_taggable(obj)) {
    throw new cmn.DeveloperError('lib/taglib.mjs', 'make_taggable', `Object was already made taggable: ${obj}`);
  }
