...
class UserService {
  ...
  // API keys
  async getUserApiKeys(uid, includeRevoked=false, includeExpired=false) {
    return this.apiKeyStore.retrieve_api_keys_by_user_id(uid, includeRevoked, includeExpired);
  }
